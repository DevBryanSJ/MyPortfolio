...
const text = {
    ...
    heroSection: {
        ...
        role: 'Full-Stack ', 
        dev: 'Engineer', 
        description: "I’ve been invested in the IT developing world, more focused on web developing. I love putting effort in developing detailed, intuitive, and useful UI and functionalities using different kinds of technologies and tools to improve quality of life of the people. ",
        contact: 'Contact me',
    }, 
    about: {
        title: "About Me ", 
        ...
        workTools: {
            git: {
                name: "Git Bash", 
                icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M2.6 10.59L8.38 4.8l1.69 1.7c-.24.85.15 1.78.93 2.23v5.54c-.6.34-1 .99-1 1.73a2 2 0 0 0 2 2a2 2 0 0 0 2-2c0-.74-.4-1.39-1-1.73V9.41l2.07 2.09c-.07.15-.07.32-.07.5a2 2 0 0 0 2 2a2 2 0 0 0 2-2a2 2 0 0 0-2-2c-.18 0-.35 0-.5.07L13.93 7.5a1.98 1.98 0 0 0-1.15-2.34c-.43-.16-.88-.2-1.28-.09L9.8 3.38l.79-.78c.78-.79 2.04-.79 2.82 0l7.99 7.99c.79.78.79 2.04 0 2.82l-7.99 7.99c-.78.79-2.04.79-2.82 0L2.6 13.41c-.79-.78-.79-2.04 0-2.82"/></svg>,
            }, 
            github: {
                name: "GitHub", 
            ...
            angular: {
                name: "Angular", 
                icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 128 128"><path fill="currentColor" d="m78.36 0l41.77 89.9l4.34-68.57zM38.87 94.47l-6.42 15.54L64 128l31.55-17.99l-6.42-15.54zM80.53 74.3L64 34.11L47.47 74.3zm-77-52.97L7.87 89.9L49.64 0z"/></svg>, 
            },
            nextjs: {
                name: "Next.js", 
        ...
        additionalTools: {
            ...
            perplexity: {
                name: "Perplexity", 
                icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m5.735 2l5.695 5.247V2.012h1.109v5.259L18.259 2v5.983h2.349v8.629h-2.342v5.327l-5.727-5.032v5.09h-1.11V16.99L5.742 22v-5.388H3.393v-8.63h2.342zm4.86 7.078H4.5v6.439h1.24v-2.031zM6.85 13.972v5.585l4.58-4.034V9.81zm5.72 1.497l4.588 4.03v-2.887h-.006v-2.646l-4.582-4.16zm5.696.048H19.5v-6.44h-6.047l4.814 4.363zm-1.115-7.534V4.519l-3.76 3.464zm-6.548 0l-3.76-3.464v3.464z"/></svg>,
            }, 
            photoshop: {
                                    ...
                                    <div className="flex flex-row flex-wrap gap-1 lg:gap-2 w-full h-auto">
                                        {Object.values(text.about.workTools).map((tool, index) => (
                                            <span key={index} 
                                                ...
                                                <span className="text-purple-200">{tool.icon}</span>{tool.name}
                                            </span>
                                        ))}
                                    </div>
                                </div>
