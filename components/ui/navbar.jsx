...
export default function Navbar({ content, cvText, cvLink, socialLinks}){
    ...
    return (
        <>
            <nav className="fixed top-0 z-50 bg-neutral-950/50 backdrop-blur-md drop-shadow-xl flex flex-row items-center justify-around py-1 md:py-5 px-10 h-16 md:h-20 w-full">
                <div className="flex flex-row items-center justify-end md:justify-between w-full">
                    ...
                    <div className="flex flex-row justify-end md:justify-around space-x-2 md:space-x-0 gap-2 sm:gap-1 lg:gap-3 w-full md:w-auto">
                        ...
                        <a href={socialLinks.x} target="_blank" rel="noopener noreferrer">
                            <button className="btn btn-circle btn-ghost text-gray-50 hover:text-purple-300 w-6 sm:w-auto md:w-5 lg:w-auto">
                        ...
                        <a href={cvLink} target="_blank" rel="noopener noreferrer">
                            <button className="flex flex-row btn bg-inherit hover:bg-inherit text-p sm:text-h6 md:text-p lg:text-h6 text-gray-50 hover:text-purple-300 shadow-none border-0 border-purple-300 rounded-none p-2 hover:border-b-2 hover:border-purple-300 focus:border-b-2 focus:border-purple-300 focus:text-purple-300">
                                {cvText}
    ...
    return (
        <>
            <nav className="fixed bottom-0 z-50 bg-neutral-950/50 backdrop-blur-md drop-shadow-xl flex flex-row md:hidden items-center justify-around py-1 md:py-5 px-5 h-16 md:h-20 w-full">
                <a href="/#hero_section" className="w-full">
                    <button className="btn bg-inherit w-full hover:bg-inherit text-h6 md:text-p lg:text-h6 text-gray-50 hover:text-purple-300 shadow-none border-0 border-purple-300 rounded-none p-2 hover:border-b-2 hover:border-purple-300 focus:border-b-2 focus:border-purple-300 focus:text-purple-300">
