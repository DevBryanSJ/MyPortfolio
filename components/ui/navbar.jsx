        ...
        <>
            <nav className="fixed bottom-0 z-50 bg-neutral-950/50 backdrop-blur-md drop-shadow-xl flex flex-row md:hidden items-center justify-around py-1 md:py-5 px-5 h-16 md:h-20 w-full">
                <a href="/#hero_section" className="w-full">
                    <button className="btn bg-inherit w-full hover:bg-inherit text-h6 md:text-p lg:text-h6 shadow-none text-gray-50 hover:text-purple-300 border-0 border-purple-300 rounded-none p-2 hover:border-t-2 hover:border-purple-300 focus:border-t-2 focus:border-purple-300 focus:text-purple-300">
