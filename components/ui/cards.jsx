    ...
    return(
        <>
            <div className="card w-[550px] h-[300px] bg-neutral-800 flex flex-row items-center justify-center overflow-hidden duration-300 group hover:-rotate-0 [transform:rotate3d(1_,-1,_1,_60deg)] shadow-lg  hover:shadow-2xl hover:shadow-purple-400 shadow-purple-400">
                <div className="flex flex-col w-full h-full items-start justify-center">
                    <div className="w-full h-2/5 p-5 flex flex-col justify-center">
                        <h5 className="text-[1.6rem] text-gray-50 font-extrabold gap-2 whitespace-pre">
                            <span className="text-purple-300 brightness-110">{role}</span>{dev}
                        </h5>
                        <h6 className="text-h5 text-gray-50 font-extrabold gap-2 whitespace-pre">
                            <span className="text-purple-300 brightness-110">{firstName}</span>{secondName}
                        </h6>
                    </div>
                    <div className="w-full h-3/5 bg-gray-100 p-5 flex flex-col justify-around gap-5">
                        <div className="text-neutral-800 font-semibold text-h6 flex flex-col w-3/5 h-1/2 ">
                            ...
                            <div className="flex flex-row items-center justify-start flex-nowrap gap-2 text-h6">
                                ...
                                <a href={emailLink} target="_blank" rel="noopener noreferrer" className="text-blue-600 link link-hover font-medium rounded-lg">
                                    {email}
                                </a>
                            </div>
                        </div>
                        <div className="text-neutral-800 font-semibold text-h6 flex flex-col w-3/5 h-1/2 ">
                            <div className="flex flex-row items-center justify-start flex-nowrap gap-2 ">
                                ...
                                <a href={cvLink} target="_blank" rel="noopener noreferrer" className="btn border-transparent hover:border-transparent bg-neutral-700 hover:bg-purple-300 hover:text-neutral-800 text-neutral-100 px-4 py-0 font-semibold rounded-lg text-h6">
                                    {cvText}
                ...
                <div className="w-auto h-auto ring-[16px] p-3 ring-purple-300 rounded-full absolute -top-1 -right-24 flex items-center justify-center">
                    <div className="avatar relative w-[19rem] h-[19rem] flex items-center justify-center ring-[16px] ring-neutral-800 bg-inherit rounded-full">
                        <Image
